...
vim.keymap.set("n", "<leader>'", [[<cmd>call VSCodeNotify('workbench.action.toggleEditorGroupLayout')<cr> <cmd>call VSCodeNotify('workbench.action.focusPreviousGroup')<cr>]])
